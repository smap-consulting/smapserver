...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateRangeInputfnCreateRangeInput(oTable) {
        ...
        function fnCreateDateRangeInput(oTable) {
           ...
           var aoFragments = sRangeFormat.split(/[}{]/);
	        ...
	        function (oSettings, aData, iDataIndex) {
				...
				dStartDate = $.format.date(dStartDate, "dd/MM/yyyy");
				
				
	            var dEndDate = to.datepicker("getDate");
				dEndDate = $.format.date(dEndDate, "dd/MM/yyyy");
	            ...
	            try {
	                ...
	                //dCellDate = $.datepicker.parseDate($.datepicker.regional[""].dateFormat, aData[_fnColumnIndex(index)]);
						//console.log(aData[_fnColumnIndex(index)]);
						dCellDate = aData[_fnColumnIndex(index)];
					//dCellDate = $.format.date(aData[_fnColumnIndex(index)],"dd/MM/yyyy hh:mm:ss");
            ...
            select.change(function () {
                ...
                else
				{
					...
					else
					{
						if ( name == "In progress")
						{
							name = '|pending|cancelled|accepted';
							
							
						}
					}
                    oTable.fnFilter(name, iColumn,false,false); //Issue 25
